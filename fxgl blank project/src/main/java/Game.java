...
public class Game extends GameApplication{
    ...
    protected void initUI() {
        Text playerScore = getUIFactoryService().newText("Score: ", Color.BLACK, 30);

        playerScore.setTranslateX(10);
        playerScore.setTranslateY(50);

        playerScore.textProperty().bind(getWorldProperties().intProperty("score").asString());

        getGameScene().addUINodes(playerScore);
    }
